...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Main Navigation */}
      <nav 
        className="shadow-lg sticky top-0 z-50 border-b-2 border-red-500 bg-[#f9fafb]"
        style={{
              ...
              {navItems.map((item) => (
                <Link
                  ...
                  className={`text-gray-700 font-medium transition-all duration-200 hover:text-gray-900 hover:scale-105 px-3 py-2 rounded-md ${
                    location === item.href ? "text-gray-900 font-bold bg-gray-200/50" : ""
                  }`}
                >
                  {item.label}
                </Link>
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              {user ? (
                ...
                <Button 
                  ...
                  className="inline-flex items-center justify-center gap-2 whitespace-nowrap ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 h-10 bg-white text-gray-700 hover:bg-gray-50 border border-gray-300 px-6 py-2 rounded-lg font-medium transition-colors duration-200 text-[16px]"
                >
                  Sign In
                </Button>
              )}
